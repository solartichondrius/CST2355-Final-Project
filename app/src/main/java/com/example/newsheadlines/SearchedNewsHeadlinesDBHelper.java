 ...
 */
public class SearchedNewsHeadlinesDBHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "SearchedDB";
    public static final int VERSION_NUM = 3;
    public static final String TABLE_NAME = "SearchedDB";
    ...
    public SearchedNewsHeadlinesDBHelper(Activity ctx){
